...
OUTPUT_DIR = "D:\\depth_ctrl\\real_scenes\\outputs_snowy"
...
def main():
    ...
    for idx, rgb_file in enumerate(rgb_files):
        ...
        *   **Visual Style:** Use [Image 1] (RGB) as the reference for object textures and local colors, but **shift the lighting and atmosphere to match a snowy day**. Reduce contrast and saturation slightly to mimic overcast lighting.
        
        **Detailed Scene Description:**
        Refer strictly to [Image 1] for the specific content, but transfer into a snowy weather condition.
